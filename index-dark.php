...
<?PHP include 'nav-bar.php'; ?>
    ...
    <section class="p-0 no-transition h-100vh" id="home">
      ...
      <div class="rev_slider_wrapper fullwidthbanner-container" id="revo_main_wrapper">
        <div class="rev_slider fullwidthabanner" data-version="5.4.8.1" id="rev_slider_5_1" style="display:none;">
          <ul>
            <!-- SLIDE -->
            <li class="banner-overlay" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut"
              ...
              <img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="7"
                   data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina src="assets/video/thumb.jpg">
              <div class="rs-background-video-layer"
                   ...
                   data-videowebm="assets/video/video.mp4"
                   data-videowidth="100%"
    ...
    <!-- Features start -->
    <section class="parallax-setting parallaxie parallax3" id="features">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-6 col-sm-12 d-xs-none wow fadeInLeft">
            <div class="text-center">
              <img alt="features" src="assets/images/features2.png">
            </div>
          </div>
    ...
    <!-- Stats start -->
    <section class="stats bg-change bg-light-gray">
      <h2 class="d-none">heading</h2>
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="skill-box">
              <div class="main-title mb-5 text-md-left wow fadeIn" data-wow-delay="300ms">
                ...
                <p> Wixer is a design studio founded in London. Nowadays, we've grown and expanded our services, and
                    have become a multinational firm, offering a variety of services and solutions Worldwide. </p>
              </div>
              <ul class="text-left">
                <li class="custom-progress">
                  <h6 class="font-18 mb-0 text-capitalize">Mobile app designs <span class="float-right"><b
                ...
                <li class="custom-progress">
                  <h6 class="font-18 mb-0 text-capitalize">Design and branding<span class="float-right"><b
                ...
                <li class="custom-progress">
                  <h6 class="font-18 mb-0 text-capitalize">custom web solutions<span class="float-right"><b
                ...
                <li class="custom-progress mb-0">
                  <h6 class="font-18 mb-0">Risk management <span class="float-right"><b
    ...
    <!-- Team start -->
    <section class="bg-change bg-light-gray" id="team">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="main-title wow fadeIn" data-wow-delay="300ms">
                ...
                <div class="swiper-slide">
                  <div class="team-coverflow">
                    ...
                    <div class="team-text">
                      ...
                      <p class="grey color-light-grey font-weight-light font-16 text-capitalize"> CEO & Founder </p>
                    </div>
                    <!--Team Progress-->
                ...
                <div class="swiper-slide">
                  <div class="team-coverflow">
                    ...
                    <div class="team-text">
                      ...
                      <p class="grey color-light-grey font-weight-light font-16 text-capitalize"> Senior Social Media
                                                                                                  Executive </p>
                    </div>
                    <!--Team Progress-->
                    <ul class="team-progress text-left">
                ...
                <div class="swiper-slide">
                  <div class="team-coverflow">
                    ...
                    <div class="team-text">
                      ...
                      <p class="grey color-light-grey font-weight-light font-16 text-capitalize">Recruit/HR Manager </p>
                    </div>
                    <!--Team Progress-->
                    <ul class="team-progress text-left">
                      <!--Progress Item-->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 text-lg-left text-md-center md-mb-5">
            <div class="main-title mb-2rem text-lg-left wow fadeIn" data-wow-delay="300ms">
              <h5> Infomation about company </h5>
              <h2> Modeling Agency </h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mauris arcu, lobortis id interdum vitae,
                 interdum eget elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mauris arcu, lobortis
                 id interdum vitae, interdum eget elit.</p>
            </div>
            <a class="btn-setting btn-hvr-setting-main btn-yellow color-white" href="javascript:void(0)">Read More
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 col-sm-12 p-0 equalheight col-video bg-summer-sky order-lg-2">
            <div class="video-content-setting center-block text-left text-xs-center equalheight">
              <h2 class="color-white font-weight-light text-capitalize mb-2rem mb-xxs-3">Design for companies and
                                                                                         freelancers.</h2>
              <p class="color-white">Wixer offers a clean and contemporary to suit a range of purposes from corporate,
                                     tech startup, marketing site to digital storefront.</p>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="main-title wow fadeInUp" data-wow-delay="250ms">
              <h5> Some of the best projects </h5>
              <h2> Amazing work </h2>
              <p>Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed suscipit. Vestibulum auctor nunc vitae
                 diam eleifend, in maximus metus sollicitudin. Quisque vitae sodales lectus. Nam porttitor justo sed mi
                 finibus, vel tristique risus faucibus. </p>
            ...
            <div class="cbp cbp-l-grid-mosaic no-transition" id="assets/js-grid-mosaic">
              ...
              <div class="cbp-item graphic portfolio-img wow fadeInUp" data-wow-delay="250ms">
                ...
                <h3 class="font-weight-normal mt-30px mb-15px sm-mt-15px sm-mb-10px color-black text-capitalize">
                  Branding Work</h3>
                <h5 class="font-weight-normal color-summer-sky mb-1 text-capitalize"> some branding ideas </h5>
              </div>
              ...
              <div class="cbp-item motion portfolio-img even wow fadeInUp" data-wow-delay="300ms">
                ...
                <h3 class="font-weight-normal mt-30px mb-15px sm-mt-15px sm-mb-10px color-black text-capitalize">
                  Photography</h3>
                <h5 class="font-weight-normal color-yellow mb-1 text-capitalize"> photography ideas </h5>
              </div>
              ...
              <div class="cbp-item print web-design even portfolio-img wow fadeInUp" data-wow-delay="350ms">
                ...
                <h3 class="font-weight-normal mt-30px mb-15px sm-mt-15px sm-mb-10px color-black text-capitalize">
                  Animation Project</h3>
                <h5 class="font-weight-normal color-green mb-1 text-capitalize"> some animated ideas </h5>
              </div>
              ...
              <div class="cbp-item print portfolio-img even wow fadeInUp" data-wow-delay="500ms">
                ...
                <h3 class="font-weight-normal mt-30px mb-15px sm-mt-15px sm-mb-10px color-black text-capitalize">SEO
                                                                                                                 Works</h3>
              ...
              <div class="cbp-item motion portfolio-img even wow fadeInUp" data-wow-delay="550ms">
                ...
                <h3 class="font-weight-normal mt-30px mb-15px sm-mt-15px sm-mb-10px color-black text-capitalize">
                  Architecture Work</h3>
                <h5 class="font-weight-normal color-summer-sky mb-md-1 m-0 text-capitalize"> Some Architecture
                                                                                             Ideas</h5>
              </div>
            </div>
          </div>
    ...
    <!-- Pricing start -->
    <section class="bg-light-gray parallax-setting parallaxie parallax4" id="pricing">
      <div class="bg-overlay bg-black2 opacity-9"></div>
      <div class="container">
        <div class="row m-0">
          <div class="col-md-12">
        ...
        <div class="row two-col-pricing">
            ...
            <div class="pricing-item advanced-plan summer-sky">
              <div class="price-box clearfix">
                <div class="price_title">
                  <h4 class="text-capitalize color-summer-sky">Basic Plan</h4>
              ...
              <a class="btn-setting btn-hvr-setting-main btn-summer-sky text-uppercase" href="javascript:void(0)">go
                                                                                                                  basic
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 text-center md-mb-5 wow fadeInUp">
            <div class="pricing-item advanced-plan yellow">
              ...
              <a class="btn-setting btn-hvr-setting-main btn-yellow text-uppercase" href="javascript:void(0)">go
                                                                                                              advanced
                <span class="btn-hvr-setting">
                                 <span class="btn-hvr-setting-inner">
                                 <span class="btn-hvr-effect"></span>
          ...
          <div class="col-lg-4 col-md-12 col-sm-12 text-center wow fadeInRight">
            <div class="pricing-item premium-plan advanced-plan green">
              <div class="price-box clearfix">
                <div class="price_title">
                  <h4 class="text-capitalize color-green">Premium Plan</h4>
                  <p>If you are a small business and you are interested in small rebranding then this is a perfect plan
                     for you</p>
                </div>
              </div>
    ...
    <!-- Clients start -->
    <section class="bg-change bg-white p-0 cursor-light no-transition" id="clients">
      <h2 class="d-none">heading</h2>
      <div class="section-padding parallax-setting parallaxie parallax1">
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center wow fadeIn" data-wow-delay="300ms">
              <h5 class="mb-10px font-weight-normal line-height-17px color-summer-sky text-capitalize">Worldwide
                                                                                                       feedback</h5>
          ...
          <div class="testimonial-images">
            <div class="owl-thumbs owl-dots d-lg-block d-none">
              ...
              <div class="owl-dot animated-wrap"><img alt="" class="animated-element"
                                                      src="assets/images/testimonial7.jpg">
              </div>
              <div class="owl-dot animated-wrap"><img alt="" class="animated-element"
                                                      src="assets/images/testimonial8.jpg">
              </div>
            </div>
          </div>
    ...
    <!-- Blog start -->
    <section class="bg-change bg-light-gray" id="blog">
      <h2 class="d-none">heading</h2>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-6 col-sm-12 mb-xs-5">
            <div class="news_item shadow blog-one">
              ...
              <div class="news_desc">
                <h3 class="text-capitalize line-height-normal"><a class="color-black" href="javascript:void(0)">Make
                                                                                                                Strategic
                                                                                                                Solutions</a>
                </h3>
          ...
          <div class="col-md-6 col-sm-12">
            <div class="news_item shadow blog-two">
              ...
              <div class="news_desc">
                <h3 class="text-capitalize line-height-normal"><a class="color-black" href="javascript:void(0)">Creating
                                                                                                                better
                                                                                                                experience</a>
                </h3>
                <ul class="meta-tags mt-20px mb-20px">
    ...
    <!-- Contact & Map starts -->
    <section class="bg-light-gray parallax-setting parallaxie parallax5" id="contact">
      <div class="bg-overlay bg-black2 opacity-9"></div>
      <div class="container">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 mb-5 wow fadeInUp" data-wow-delay="400ms">
            <div class="contact-box-shadow">
              <div class="text-left sm-text-center w-100">
                <h2 class="color-black font-weight-normal mb-2rem text-capitalize"> Connect with Wixer.</h2>
                <p class="contact-para-setting">
                  Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed suscipit. Vestibulum auctor nunc vitae
                  diam eleifend.
                </p>
              </div>
              ...
              <form class="contact-form-outer" onsubmit="return false;">
                <div class="row">
                  ...
                  <div class="col-lg-12 pt-xs-25px text-center">
                    <button class="btn-setting btn-hvr-setting-main btn-yellow btn-hvr" id="submit_btn" type="submit"><i
